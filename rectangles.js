...
(function() {
  ...
  Rectangle = (function() {
    ...
    function Rectangle(binary) {
      var a, start;
      start = 0;
      this.ybar = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.xbar = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.y = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.x = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.r = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.g = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      this.b = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      start += varBitCount;
      a = Binary.toInt(binary.slice(start, +(start + varBitCount) + 1 || 9e9));
      this.a = a / 255;
      start += varBitCount;
    }
  ...
  RectangleCollection = (function() {
    ...
    function RectangleCollection(binary, g) {
      ...
      while (start !== binary.length) {
        rectangleBinary = binary.slice(start, +(start + Rectangle.bitCount) + 1 || 9e9);
